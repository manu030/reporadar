    ...
    repoData.forEach((item, index) => {
      ...
      reposHtml += `
        <div style="margin-bottom: 30px; padding: 20px; border-left: 4px solid #FF9B9B; background-color: #fafafa;">
          <h3 style="color: #333; margin-bottom: 12px; font-size: 18px;"><strong>${repo.name}</strong></h3>
          <p style="color: #666; margin-bottom: 20px; line-height: 1.5;">${repo.description}</p>
