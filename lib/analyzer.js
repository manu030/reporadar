...
class AIAnalyzer {
  constructor() {
    ...
    // Simple validation to prevent crashes with invalid keys
    const isValidKey = (key) => key && key.length > 10 && !key.includes('placeholder') && !key.includes('your_');
    
    if (this.openrouterApiKey && isValidKey(this.openrouterApiKey)) {
      ...
      this.testMode = false;
    } else if (this.openaiApiKey && isValidKey(this.openaiApiKey)) {
  ...
  "ideas": [
    {
      ...
      "description": "Resumen atractivo de la idea en 1-2 frases que engancha al lector",
  ...
  "ideas": [
    {
      ...
      "description": "Attractive summary of the idea in 1-2 sentences that hooks the reader",
...
Respond only with valid JSON following the specified format.`
    ...
    try {
      ...
      const validIdeas = parsed.ideas.filter(idea => 
        ...
        idea.description && typeof idea.description === 'string' && idea.description.trim().length > 0 &&
      ...
      es: [
        {
          ...
          description: `Convierte cualquier herramienta open source en un servicio cloud rentable eliminando la complejidad técnica para desarrolladores.`,
        ...
        },
        {
          ...
          description: `Monetiza el ecosistema open source creando el "App Store" para extensiones y plugins de herramientas populares.`,
        ...
        },
        {
          ...
          description: `Elimina silos de información conectando herramientas técnicas con workflows empresariales existentes de forma automática.`,
      ...
      en: [
        {
          ...
          description: `Turn any open source tool into a profitable cloud service by eliminating technical complexity for developers.`,
        ...
        },
        {
          ...
          description: `Monetize the open source ecosystem by creating the "App Store" for extensions and plugins of popular tools.`,
        ...
        },
        {
          ...
          description: `Eliminate information silos by automatically connecting technical tools with existing enterprise workflows.`,
